    ...
    <SmoothScroll>
      <main className="relative bg-[#B0B5B9] text-foreground">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center pb-32 -mt-[180vh]">
          ...
          {/* Footer overlay */}
          <div className="absolute bottom-8 left-0 w-full text-center text-xs uppercase tracking-widest text-[#2c3e50]/60 mix-blend-multiply">
            <p>&copy; 2024 LXRY. All Rights Reserved.</p>
          </div>
        </div>
